...
if GROQ_API_KEY:
    try:
        ...
        print("[AI] Groq client loaded (llama-3.3-70b-versatile)")
    except Exception as e:
        print(f"[AI] Groq setup failed: {e}")
else:
    print("[AI] No GROQ_API_KEY found. AI features disabled.")
...
def ai_status():
    return jsonify({
        "geminiEnabled": groq_client is not None,
        "message": "Groq AI active (Llama 3.3 70B)" if groq_client else "AI unavailable — set GROQ_API_KEY in .env",
    })
